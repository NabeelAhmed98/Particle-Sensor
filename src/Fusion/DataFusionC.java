 ...
 * @author 23554853
 */
public class DataFusionC extends DataFusion{

    public DataFusionC(String NodeID, Location location, ArrayList<ArrayList<Integer>> codeBuffer, ArrayList<Integer> fusedBuffer) {
    ...
    public void writeDataToFile() {
        try {
            int counter = 0;
            BufferedWriter bw = new BufferedWriter(new FileWriter(Fusionable.FILEC));
