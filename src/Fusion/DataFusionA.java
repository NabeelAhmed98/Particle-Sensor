 ...
 * @author 23554853
 */
public class DataFusionA extends DataFusion{

    public DataFusionA(String NodeID, Location location, ArrayList<ArrayList<Integer>> codeBuffer, ArrayList<Integer> fusedBuffer) {
    ...
    public void writeDataToFile() {
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter(Fusionable.FILEA));
