 ...
 * @author 23554853
 */
public class DataAnalyticsC extends DataAnalytics{

    public DataAnalyticsC(String NodeID, Location location, ArrayList<Integer> filebuffer, double[] analysisValues) {
    ...
    public void readFusedData() {
        try {
            BufferedReader br = new BufferedReader(new FileReader(Fusionable.FILEC));
    ...
    public void writeDataToFile() {
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter(Analyzable.FILEAC));
            bw.write("SENSOR C ANALYSIS\n");
