...
import static StatsSupport.JStats.*;
 ...
 * @author 23554853
 */
public class DataAnalyticsA extends DataAnalytics{

    public DataAnalyticsA(String NodeID, Location location, ArrayList<Integer> filebuffer, double[] analysisValues) {
    ...
    public void readFusedData() {
        try {
            BufferedReader br = new BufferedReader(new FileReader(Fusionable.FILEA));
    ...
    public void writeDataToFile() {
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter(Analyzable.FILEAA));
